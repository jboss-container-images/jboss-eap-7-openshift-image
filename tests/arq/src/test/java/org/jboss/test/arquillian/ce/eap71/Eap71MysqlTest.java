...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-openshift}/application-templates/${template.branch:master}/eap/eap71-mysql-s2i.json", parameters = {
...
public class Eap71MysqlTest extends EapDbTestBase {
}
