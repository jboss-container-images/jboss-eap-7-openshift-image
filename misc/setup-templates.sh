...
oc create -n openshift -f templates/eap-cd-image-streams.json
...
docker tag jboss-eap-7-tech-preview/eap-cd-openshift:12.0 $CLUSTER_IP:5000/openshift/eap-cd-openshift:12
docker tag jboss-eap-7-tech-preview/eap-cd-openshift:12.0 $CLUSTER_IP:5000/openshift/eap-cd-openshift:12.0
docker push $CLUSTER_IP:5000/openshift/eap-cd-openshift:12
docker push $CLUSTER_IP:5000/openshift/eap-cd-openshift:12.0
